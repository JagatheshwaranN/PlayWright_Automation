...
public class SetContentTest {
    ...
    @Test
    public void testFrameSetContent() {
        ...
        try {
            ...
            frame.setContent("<h1 id='header'>Playwright Frame - Set HTML Content Dynamically</h1>");

            // Use a locator to find an element with the id "header" inside the frame
            String frameContent = frame.locator("#header").textContent();
