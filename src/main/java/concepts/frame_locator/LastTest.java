...
public class LastTest {
    ...
    @Test
    public void testFrameLocatorLast() {
        ...
        try {
            ...
            // Locate the last frame and find an element by its ARIA role as a heading
            Locator headerElement = frame.last().getByRole(AriaRole.HEADING);
