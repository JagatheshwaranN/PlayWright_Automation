...
public class GetByTextTest {
    ...
    public void testPageGetByText() {
        ...
        try {
            ...
            // Using the getByText method to locate an element with the text content "Teddy Bears" within the page
            String headerText = page.getByText("Teddy Bears").textContent();
