...
public class GoForwardTest {
    ...
    public void testPageGoForward() {
        ...
        try {
            ...
            // Get the title of the page after going back
            title = page.title();

            // Print the title of the page after going back
            System.out.println("Page Title: " + title);

            // Go forward to the next page with network idle state as a condition
            page.goForward(new Page.GoForwardOptions().setWaitUntil(WaitUntilState.NETWORKIDLE));

            // Get the title of the page after going forward
            title = page.title();

            // Print the title of the page after going forward
            System.out.println("Page Title: " + title);
        } catch (Exception ex) {
