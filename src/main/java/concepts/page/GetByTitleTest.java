...
public class GetByTitleTest {
    ...
    @Test
    public void testPageGetByTitle() {
        ...
        try {
            ...
            // Locate an element within the page using its title attribute with the value "teddy"
            Locator headerElement = page.getByTitle("teddy");
